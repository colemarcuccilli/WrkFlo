  ...
  return (
    ...
    >
      <path
        ...
        d="M 180,135 L 210,203 L 240,135 L 270,203 L 300,135"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[1]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 320,135 L 320,215"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[2]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 320,175 C 320,145 340,135 365,135"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[3]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 390,85 L 390,215"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[4]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 430,135 L 390,175"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[5]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 405,160 L 440,215"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[6]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 470,215 L 470,115 C 470,95 480,85 500,85"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[7]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 455,135 L 490,135"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[8]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 520,85 L 520,215"
      />
      <path
        fill="none"
        stroke={PATH_COLORS[9]}
        strokeWidth={strokeW}
        strokeLinecap="butt"
        strokeLinejoin="miter"
        d="M 606,206 A 40 40 0 1 1 620,175"
      />
...
export default function AnimatedLandingPage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Compare rows slide in from alternating sides
  ...
  // ── Comparison data ───────────────────────────────────────────────────────
  const compareRows = [
    { feature: 'Client sign-up required', wrkflo: false, frameio: true },
    { feature: 'No-account review links', wrkflo: true, frameio: false },
    { feature: 'Free tier available', wrkflo: true, frameio: false },
    { feature: 'Built for indie creators', wrkflo: true, frameio: false },
    { feature: 'Timestamped comments', wrkflo: true, frameio: true },
    { feature: 'Password-protected links', wrkflo: true, frameio: true },
    { feature: 'Affordable pricing', wrkflo: true, frameio: false },
    { feature: 'Real-time collaboration', wrkflo: true, frameio: true },
  ];
    ...
    <div style={{ background: '#0a0a0f', color: '#fff', minHeight: '100vh', overflowX: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <Link href="/login" style={{
              ...
              color: CYAN, textDecoration: 'none', fontSize: 14, fontWeight: 500,
              transition: 'all 0.2s',
            }}
      ...
      <section ref={heroRef} style={{
        ...
        <div ref={ctasRef} style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
          <a href="#waitlist" className="cta-primary" style={{
            padding: '14px 32px', borderRadius: 10,
            background: `linear-gradient(135deg, ${CYAN}, ${MINT})`,
            color: '#0a0a0f', fontSize: 16, fontWeight: 700, textDecoration: 'none',
            boxShadow: `0 0 30px rgba(21,243,236,0.35)`,
          ...
          <Link href="/dashboard" className="cta-ghost" style={{
            padding: '14px 32px', borderRadius: 10,
            ...
            {[
              {
                ...
                desc: 'Clients click your link and review instantly. No account, no app download, no friction. Faster approvals, happier clients.',
              },
              {
                icon: <IconSync />,
                color: BLUE,
                title: 'Real-Time Sync',
                desc: 'Comments sync live between you and your client. Timestamped feedback pins to exact moments. No more email chains.',
              },
              {
                icon: <IconFile />,
                color: MINT,
                title: 'All Creative File Types',
              ...
              <div
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = `0 0 30px ${color}15, inset 0 0 30px ${color}05`;
              ...
              <div key={num} style={{ display: 'flex', alignItems: 'center', flex: '1 1 280px' }}>
                ...
                {i < 2 && (
                  <div className="connector-line" style={{
                    ...
                    flexShrink: 0,
                    borderRadius: 2,
                    boxShadow: `0 0 8px ${i === 0 ? CYAN : BLUE}80`,
                  }} />
                )}
              </div>
            ))}
        ...
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', marginTop: 12, fontSize: 15 }}>
              Frame.io was built for Hollywood. WrkFlo was built for you.
            </p>
          </div>
          ...
          <div style={{
            ...
            <span style={{ textAlign: 'center', fontWeight: 600, color: 'rgba(255,255,255,0.35)', fontSize: 14 }}>Frame.io</span>
          </div>

          {/* Rows */}
          {compareRows.map(({ feature, wrkflo, frameio }, i) => (
            <div key={feature} className="compare-row" style={{
              display: 'grid', gridTemplateColumns: '1fr 120px 120px',
              padding: '16px 24px',
              background: i % 2 === 0 ? 'rgba(255,255,255,0.015)' : 'transparent',
              borderRadius: 8,
              borderLeft: wrkflo && !frameio ? `2px solid ${CYAN}30` : '2px solid transparent',
              alignItems: 'center',
            }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                {wrkflo ? (
                  <span style={{
                    ...
                    background: `rgba(22,255,192,0.12)`,
      ...
      <section style={{ padding: '64px 0', background: '#0a0a0f', overflow: 'hidden' }}>
        <div style={{ marginBottom: 20 }}>
          <div className="marquee-track" style={{ display: 'flex', gap: 0, whiteSpace: 'nowrap' }}>
            {[0, 1].map(i => (
              <span key={i} style={{
                color: `${CYAN}70`, fontSize: 15, fontWeight: 600, letterSpacing: '0.04em',
        ...
        <div>
          <div className="marquee-track-reverse" style={{ display: 'flex', gap: 0, whiteSpace: 'nowrap' }}>
            {[0, 1].map(i => (
              <span key={i} style={{
                color: `${MINT}60`, fontSize: 15, fontWeight: 600, letterSpacing: '0.04em',
                paddingRight: 40, flexShrink: 0,
              }}>
                {marqueeText}&nbsp;&nbsp;&nbsp;&nbsp;
              </span>
      ...
      <section id="waitlist" ref={waitlistRef} className="waitlist-section" style={{
        ...
        <div aria-hidden="true" className="waitlist-bg" style={{
        ...
        <div className="waitlist-content" style={{
          ...
          {submitted ? (
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: 10, color: MINT }}>
                You&rsquo;re on the list 🎉
              </h3>
              <p style={{ color: 'rgba(255,255,255,0.5)' }}>
                We&rsquo;ll reach out when WrkFlo launches. Get ready to move fast.
              </p>
            </div>
          ) : (
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
                <input
                  ...
                  style={{
                    ...
                    border: `1px solid rgba(21,243,236,0.25)`,
                    color: '#fff', fontSize: 15, outline: 'none',
                    transition: 'border-color 0.2s, box-shadow 0.2s',
                  }}
                  onFocus={e => {
                    e.currentTarget.style.borderColor = CYAN;
                    e.currentTarget.style.boxShadow = `0 0 0 3px rgba(21,243,236,0.15)`;
                  }}
                  onBlur={e => {
                ...
                <button type="submit" disabled={submitting} style={{
                  ...
                  boxShadow: `0 0 24px rgba(21,243,236,0.35)`,
      ...
      <footer style={{
        ...
        background: '#050508',
        borderTop: `1px solid rgba(21,243,236,0.08)`,
        boxShadow: `0 -1px 0 ${CYAN}15`,
      }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: 13 }}>© 2026 WrkFlo. All rights reserved.</span>
      ...
      <style jsx global>{`
        ...
        .waitlist-bg {
          background: linear-gradient(
            135deg,
            rgba(21,243,236,0.06) 0%,
            rgba(91,199,249,0.06) 33%,
            rgba(22,255,192,0.06) 66%,
            rgba(21,243,236,0.06) 100%
          );
